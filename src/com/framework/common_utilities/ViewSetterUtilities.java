...
public class ViewSetterUtilities {
	...
	public static Button setOnclickButton(View rootView, int buttonResource, View.OnClickListener listener){
		Button button = (Button) rootView.findViewById(buttonResource);
